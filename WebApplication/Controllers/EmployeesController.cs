...
namespace WebApplication.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,Name,Address,Gender,Phone,Birthday,Email")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,Name,Address,Gender,Phone,Birthday,Email")] Employee employee)
        {
            if (ModelState.IsValid)
            {
